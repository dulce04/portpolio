...
function start() {
    ...
    var canvas = document.getElementById("canvas"),
        ...
        shootingStars = [],
        layers = [
            { speed: 0.08, scale: 0.2, count: 800 },
    ...
    function drawStar(star) {
        context.fillStyle = "rgb(255, 225, 255)";
        context.beginPath();
        context.arc(star.x, star.y, star.radius, 0, Math.PI * 1.5, false);
        context.fill();
    }
    ...
    function drawShootingStar(p) {
        ...
        //trail
        context.fillStyle = "rgba(255, 221, 255, " + p.opacity + ")";
        context.beginPath();
        context.moveTo(x - 1, y - 1);
